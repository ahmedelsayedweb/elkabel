...
class storeLocatorWidget extends WP_Widget
{
	...
	function form($instance){
		...
		<div class="gp_widget_form_wrapper">
			<p class="hide_in_popup"><label for="<?php echo $this->get_field_id('title'); ?>">Widget Title: <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></label></p>
			...
			<fieldset class="radio_text_input">
				...
				<p><label title="Standard">
					<input type="radio" value="" id="<?php echo $this->get_field_id('search_results_style'); ?>" name="<?php echo $this->get_field_name('search_results_style'); ?>" <?php if($search_results_style == ''): ?>checked="CHECKED"<?php endif; ?>>
					<span>Standard</span>
				</label></p>
				<p><label title="Tile">
					<input type="radio" value="tile" id="<?php echo $this->get_field_id('search_results_style'); ?>" name="<?php echo $this->get_field_name('search_results_style'); ?>" <?php if($search_results_style == 'tile'): ?>checked="CHECKED"<?php endif; ?>>
					<span>Tile</span>
				</label></p>
			</fieldset>
