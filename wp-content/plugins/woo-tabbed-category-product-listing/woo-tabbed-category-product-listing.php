        ...
        <form action="<?php echo esc_attr($action); ?>" method="POST" enctype="multipart/form-data">
            <div class="qc_woo_free_admin">
                ...
                <div class="qc_woo_free_admin_right">
                    ...
                    <ul>
                        <li>9 modern design templates</li>
                        <li>AJAX load more</li>
                        <li>Collapsible category links widget</li>
                        <li>Category wise sale/featured products</li>
                        <li>Tabbed, Accordion and Carousel modes!</li>
                        <li>Complete Color Customization Options</li>
                    </ul>
